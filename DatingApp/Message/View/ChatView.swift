...
class ChatView: UIView {
    ...
    private let sendButton = CustomButton(imageName: "paperplane.fill", size: 20, color: Constants.Colors.amour, cornerRadius: nil, shadowColor: nil, backgroundColor: .clear)
